...
ALTER TABLE MEMBER ADD CONSTRAINT CONSTRAINT_87 PRIMARY KEY(ID);

ALTER TABLE MEMBER ADD CONSTRAINT FKCJTE2JN9PVO9UD2HYFGWCJA0K FOREIGN KEY(TEAM_ID) REFERENCES TEAM(ID) NOCHECK;
ALTER TABLE MEMBER ADD CONSTRAINT UKEH2I1H8TDMMMEK1V2HYI6PXCF UNIQUE(USER_ID, TEAM_ID);
